...
<head>
  <meta charset="UTF-8">
  <title>Introduccion a la Inyeccion SQL</title>
...
<link href="plugins/font-awesome/css/style.css" rel="stylesheet" type="text/css" />
...
<?php if(isset($_SESSION["user_id"]) || isset($_SESSION["client_id"])):?>
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-mini"><b>SQL</b>i</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>SISTEMA-</b>Sqli</span>
        </a>
...
<div class="user-panel">
    ...
    <?php endif;?>
      ...
      <div class="content">
        ...
        <strong>2020 <a href="#" target="_blank">Sistema</a></strong>
      </footer>
      <?php else:?>
	...
	<div class="overlay-container">
		<div class="overlay">
			...
			<div class="overlay-panel overlay-right">
				<h1>Benvenido !</h1>
				<p>Curso de Introducción a Inyección SQL</p>
...
<footer>
	<p>
		...
		<a target="_blank" href="#">Yury Daniel</a>
		- Se recomienda no utilizar en Producción
